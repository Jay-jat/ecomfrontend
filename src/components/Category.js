...
function Category() {
  ...
  return (
    <div className='h-[52vh] w-[100%] bg-white justify-center items-center mt-5'>
        ...
        <div onClick={()=> {localStorage.setItem("category", "watches") ;navigate("/manyproduct")}} className='flex h-[40vh] w-[15%]'>
            <img className=' rounded-2xl' src='https://www.gonoise.com/cdn/shop/files/Smartwatches-D.webp?v=1729498070'></img>
        </div>
        <div onClick={()=> {localStorage.setItem("category", "headphones") ;navigate("/manyproduct")}}  className='flex gap-2 h-[40vh] w-[15%] '>
            <img className=' rounded-2xl' src='https://www.gonoise.com/cdn/shop/files/Audio-D.webp?v=1729498106'></img>
        </div>
        <div onClick={()=> {localStorage.setItem("category","powerseries"); navigate("/manyproduct")}}  className='flex gap-2 h-[40vh] w-[15%] '>
