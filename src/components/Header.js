  ...
  return (
    <header className="bg-black z-10 fixed w-[100%] h-[8vh] text-white flex justify-between lg:px-[8%]  items-center">
      ...
      <div className="lg:flex hidden text-[14px] gap-4 ">
          ...
          <div className="category-div bg-white absolute top-[8vh] left-0  w-full flex justify-center ">
            <div className="w-[85%] py-6 flex gap-6 h-[90vh]">
              <div className="w-[40%] flex flex-col">
                ...
                <div className="w-full flex gap-[20%] mt-[6%] ">
                  <div className="w-[40%] h-[30vh] flex flex-col gap-2 bg-[] overflow-y-scroll">
                    <label className="text-[15px] text-[black] underline">
                      SHOP BY TYPE
                    </label>
                    <label className="text-[13px] text-[black] underline">
                      AMOLED Smartwatches
                    </label>
                    <label className="text-[13px] text-[black] underline">
                      Sports SmartWacthes
              ...
              <div className="w-[60%] flex flex-col gap-[3%] justify-center">
                <div>
                  <label className="text-[15px] text-[black] underline flex">
                    CHOOSE A CATEGORY
                  </label>
                </div>
                <div className="category-image flex gap-[5%]">
                  <div className="">
                    <img
                      ...
                      src="https://www.gonoise.com/cdn/shop/files/flagship-gear.png"
                    ></img>
                  </div>
                  <div className="">
                    <img
                      className=" h-[25vh] object-cover"
                      src="https://www.gonoise.com/cdn/shop/files/tech-spotlight.png"
                    ></img>
                  </div>
                  <div className="">
                    <img
                      className=" h-[25vh] object-cover"
                      src="https://www.gonoise.com/cdn/shop/files/lifestyle-tech.png"
                    ></img>
                  </div>
                </div>
                <div className=" flex  gap-[5%]">
                  <div className="">
                    <img
                      className=" h-[25vh] object-cover"
                      src="https://www.gonoise.com/cdn/shop/files/shine-by-noise.png"
                    ></img>
                  </div>
                  <div className="">
                    <img
                      className=" h-[25vh] object-cover"
                      src="https://www.gonoise.com/cdn/shop/files/made-for-kids.png"
                    ></img>
                  </div>
                  <div className="">
                    <img
                      className=" h-[25vh] object-cover"
                      src="https://www.gonoise.com/cdn/shop/files/view-all-watches.png"
                    ></img>
                  </div>
                </div>
              </div>
        ...
        <div className="lg:flex hidden text-[14px] gap-4 justify-center items-center">
                ...
                <div className="w-[60%] flex flex-col gap-[3%] justify-center">
                  ...
                  <div className="category-image flex gap-[5%]">
                    <div className="">
                      <img
                        className=" h-[25vh] object-cover"
                        src="https://www.gonoise.com/cdn/shop/files/enc-tws.png"
                      ></img>
                    </div>
                    <div className="">
                      <img
                    ...
                    <div className="">
                      <img
                        className=" h-[25vh] object-cover"
                        src="https://www.gonoise.com/cdn/shop/files/all-headphones.png"
                      ></img>
                    </div>
                  </div>
                  <div className=" flex  gap-[5%]">
                    <div className="">
                      <img
                        className=" h-[25vh] object-cover"
                        src="https://www.gonoise.com/cdn/shop/files/neckbands.png"
                      ></img>
                    </div>
                    <div className="">
                      <img
                        className=" h-[25vh] object-cover"
                        src="https://www.gonoise.com/cdn/shop/files/speakers.png"
                      ></img>
                    </div>
                    <div className="">
                      <img
                        className=" h-[25vh] object-cover"
                        src="https://www.gonoise.com/cdn/shop/files/view-all-audio.png"
                      ></img>
                    </div>
                  </div>
                </div>
          ...
          <div onClick={() => navigate("/gift")} className="gift-div">
            <label className="h-[8vh] flex items-center text-[15px] font-bold cursor-pointer ">
              Gift Store
            </label>
          </div>
        </div>
      ...
      <div className="text-white flex lg:gap-5 gap-3 lg:text-[16px] text-[20px] ml-2">
        {showModal == "Search Bar" ? (
          <i
            onClick={() => setShowModal("")}
            class="fa fa-times text-[20px] "
            aria-hidden="true"
          ></i>
        ) : (
          <i
        ...
        <i
          ...
          class=" cursor-pointer fa fa-user text-[22px]"
          aria-hidden="true"
        ></i>
        <i
          onClick={() => setShowModal("MyCart")}
          class=" cursor-pointer fa fa-shopping-cart text-[20px]"
          aria-hidden="true"
        ></i>
      </div>
